								...
								<div class="box">
									<div class="box-body">
										<div class="form-group">
											...
											<div class="col-xs-4">
												<p class="form-control-static"><img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>${currency(currentUser.balance, false, true)}</p>
											</div>
										</div>
										[#if currentUser.frozenFund > 0]
											<div class="form-group">
												...
												<div class="col-xs-4">
													<p class="form-control-static"><img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>${currency(currentUser.frozenFund, false, true)}</p>
												</div>
											</div>
										[/#if]
										<div class="form-group">
											...
											<div class="col-xs-4">
												<input id="amount" name="amount" class="form-control" type="text" maxlength="16" onkeyup="jisuanamount()">
											</div>
										</div>
										<div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label class="col-xs-2 control-label item-required" for="accountName">开户名称:</label>
                                            <div class="col-xs-4">
                                                <input id="accountName" name="accountName" class="form-control" type="text" maxlength="16">
                                            </div>
                                        </div>
										<div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label class="col-xs-2 control-label item-required" for="account">实际提现到账:</label>
                                            <div class="col-xs-4" style="padding-top: 8px;">
                                              <span id="shijiAmount">0</span>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-xs-2 control-label" for="account">提现备注:</label>
                                            <div class="col-xs-4" style="padding-top: 8px;">
                                               需扣除第三方支付服务费=提现金额*0.6%（非爱帮伴平台收取）
                                            </div>
                                        </div>
									</div>
