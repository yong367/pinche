											...
											<tbody>
												[#list page.content as product]
													<tr>
														...
														<td><img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>${currency(product.price, false)}</td>
														<td>
														...
														<td>
															...
															[/#if]
																...
																<a href="${base}/business/product/skuList?productId=${product.id}" >券码管理</a>
																[/#if]
														</td>
													</tr>
												[/#list]
