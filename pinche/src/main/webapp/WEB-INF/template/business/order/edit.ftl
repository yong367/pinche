			...
			timeouts[name] = setTimeout(function() {
				if ($orderForm.valid()) {
					$.ajax({
						...
						cache: false,
						success: function(data) {
							$amount.html('<img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>'+currency(data.amount, false));
						}
					});
				}
			}, 500);
										...
										<div class="tab-content">
											<div id="base" class="tab-pane active">
												<div class="row">
													<div class="col-xs-6">
														<dl class="items dl-horizontal">
															...
															<dd id="amount" class="text-red"><img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>${currency(order.amount, false)}</dd>
														...
														<dl class="items dl-horizontal">
															...
															<dd>
																...
																[#if order.amountPayable > 0]
																	(${message("Order.amountPayable")}: <img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>${currency(order.amountPayable, false)})
																[/#if]
															</dd>
												...
												<div class="row">
                                                    ...
                                                    <div class="col-xs-6">
                                                        <div class="form-group">
                                                            <label class="col-xs-4 control-label" for="rewardDuiBan">赠送兑伴:</label>
                                                            <div class="col-xs-8">
                                                                <input id="rewardDuiBan" name="rewardDuiBan" class="form-control" type="text" value="${order.rewardDuiBan}" maxlength="9">
                                                            </div>
                                                        </div>
                                                    </div>
													<div class="col-xs-6">
