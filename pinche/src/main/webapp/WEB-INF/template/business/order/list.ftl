...
<head>
	...
	function exportExcel(){
        $("#dataForm").prop("action","${base}/business/order/list/export");
        $("#dataForm").submit();
        $("#dataForm").prop("action","${base}/business/order/list");
	}
	</script>
</head>
		...
		<div class="content-wrapper">
			<div class="container-fluid">
				...
				<section class="content">
					<div class="row">
						<div class="col-xs-12">
							<form action="${base}/business/order/list" method="get" id="dataForm">
									...
									<div class="modal-dialog">
										<div class="modal-content">
											...
											<div class="modal-body form-horizontal">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-xs-3 control-label">会员:</label>
                                                    <div class="col-xs-7">
                                                        <input type="text" name="memberUsername" class="form-control" value="${memberUsername}" maxlength="200" \/>
                                                    </div>
                                                </div>
											</div>
											<div class="modal-footer">
										...
										<div class="row">
											<div class="col-xs-9">
												<div class="btn-group">
                                                    ...
                                                    <button class="btn btn-default" type="button" data-toggle="#" onclick="exportExcel()">导出Excel</button>
													<div class="btn-group">
											...
											<tbody>
												[#list page.content as order]
													<tr>
														...
														<td>${order.sn}</td>
														<td><img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>${currency(order.amount, false)}</td>
