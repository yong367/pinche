		...
		<div class="content-wrapper">
			<div class="container-fluid">
				<section class="content-header">
					<h1>${message("business.storeClerk.list")}</h1>
					<ol class="breadcrumb">
						<li>
						...
						<li class="active">${message("business.storeClerk.list")}</li>
					</ol>
				</section>
				<section class="content">
					<div class="row">
						<div class="col-xs-12">
							<form action="${base}/business/store_clerk/list" method="get">
										...
										<table class="table table-hover">
											<thead>
												<tr>
                                                    ...
                                                    </th><th>${message("StoreClerk.openId")}</th>
													<th>
														<a href="javascript:;" data-order-property="name">
															${message("StoreClerk.name")}
															<i class="fa fa-sort"></i>
														</a>
													</th><th>${message("StoreClerk.phone")}</th>
                                                    <th>${message("business.common.action")}</th>
												</tr>
											</thead>
											<tbody>
												[#list page.content as storeClerk]
													<tr>
														<td>
															<input name="ids" type="checkbox" value="${storeClerk.id}">
														</td>
                                                        <td>${storeClerk.openId}</td>
														<td>${storeClerk.name}</td>
														<td>${storeClerk.phone}</td>
														<td>
															<a href="${base}/business/store_clerk/edit?storeClerkId=${storeClerk.id}">[${message("business.common.edit")}]</a>
														</td>
													</tr>
												[/#list]
											</tbody>
