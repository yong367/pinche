...
<aside class="main-sidebar" style="padding-top: 80px">
	<section class="sidebar">
		...
		<ul class="sidebar-menu">
           [#-- <li class="header" style="font-size: 16px;">智慧营销</li>
            <li class="treeview [#if .main_template_name?matches(".*/task/.*")] active[/#if]">
                <a href="javascript:;">
                ...
                <ul class="treeview-menu">
                    <li[#if .main_template_name?matches(".*/task/list.*")] class="active"[/#if]>
                        <a href="${base}/business/task/list">
                            <i class="fa fa-circle-o"></i>
                            分销任务
                        </a>
                    </li>
                    <li[#if .main_template_name?matches(".*/task/receivableTaskList.*")] class="active"[/#if]>
                        <a href="${base}/business/task/receivableTaskList">
                            <i class="fa fa-circle-o"></i>
                            任务大厅
                        </a>
                    </li>
                    <li[#if .main_template_name?matches(".*/task/receiveTaskList.*")] class="active"[/#if]>
                        <a href="${base}/business/task/receiveTaskList">
                            <i class="fa fa-circle-o"></i>
                            已接任务
                        </a>
                    </li>
                    <li[#if .main_template_name?matches(".*/task/taskFenSi.*")] class="active"[/#if]>
                        <a href="${base}/business/task/taskFenSi">
                            <i class="fa fa-circle-o"></i>
                            我的粉丝
                        </a>
                    </li>
                    <li[#if .main_template_name?matches(".*/task/pushList.*")] class="active"[/#if]>
                        <a href="${base}/business/task/pushList">
                            <i class="fa fa-circle-o"></i>
                            推送列表
                        </a>
                    </li>
            ...
            <li class="header" style="font-size: 16px;">兑伴儿商城</li>
			...
			<li class="treeview[#if .main_template_name?matches(".*/store/setting.*|.*/store_product_category/.*|.*/store_product_tag/.*|.*/category_application/.*|.*/store/payment.*|.*/shipping_method/.*|.*/area_freight_config/.*|.*/store_ad_image/.*")] active[/#if]">
				...
				<ul class="treeview-menu">
                    ...
                    <li[#if .main_template_name?matches(".*/store_qr_code/.*")] class="active"[/#if]>
                        <a href="${base}/business/store/getQR">
                            <i class="fa fa-circle-o"></i>
						${message("business.common.qrCode")}
                        </a>
                    </li>
                    <li[#if .main_template_name?matches(".*/store_ad_image/.*")] class="active"[/#if]>
                        <a href="${base}/business/store_clerk/list">
                            <i class="fa fa-circle-o"></i>
                            <span>${message("business.mainSidebar.storeClerkList")}</span>
                        </a>
                    </li>
            ...
            <li class="header" style="font-size: 16px;">账户管理</li>
			...
			<li class="header" style="font-size: 16px;">数据统计</li>
