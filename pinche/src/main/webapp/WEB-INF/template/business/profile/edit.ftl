										...
										<div class="row">
											<div class="col-xs-6">
												<dl class="items dl-horizontal clearfix">
													...
													<dd><img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>${currency(currentUser.balance, false)}</dd>
													[#if currentUser.frozenFund > 0]
														<dt>${message("Business.frozenFund")}:</dt>
														<dd><img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>${currency(currentUser.frozenFund, false)}</dd>
													[/#if]
													<dt>${message("Store.bailPaid")}:</dt>
													<dd><img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>${currency(currentStore.bailPaid, false)}</dd>
