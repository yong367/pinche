								...
								<div class="list-group-item">
									<div class="media">
										...
										<div class="media-body">
											...
											[/#if]
											<strong class="red"><img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>${currency(cartItem.price, false)}</strong>
										</div>
			...
			<div class="row">
				<div class="col-xs-6 text-center">
					[#if currentCart?? && currentCart.cartItems?has_content]
						...
						<strong id="effectivePrice" class="red"><img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>${currency(currentCart.getEffectivePriceTotal(currentCart.stores), false, true)}</strong>
					[/#if]
				</div>
				<div class="col-xs-3">
