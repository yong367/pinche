        ...
        $(function () {
            ...
            $shopList.infiniteScroll({
                url: function(pageNumber) {
                    ...
                    return "${base}/store/allProductAjax?pageNumber=" + pageNumber+"&storeId=${store.id}&descName=monthHits"+"&fenLeiId="+fenLeiId;
                },
                pageSize: 10,
...
function showFenLei(){
        ...
        function selectFenLei(id) {
            ...
            if(orderName=='priceAsc'){
                window.location.href='${base}/store/allProduct/monthHits_up/'+${store.id}+'/'+id;
            }else{
                window.location.href='${base}/store/allProduct/monthHits_down/'+${store.id}+'/'+id;
            }
        }
        function submitForm() {
...
<div class="flex flex-align-center shop_list_type">
    <div class="flex-1 shop_list_type_item">
        <input type="radio" name="shop_list_type" lt="monthHits" id="slt1" onclick="shop_list_type_change(this)" checked>
