				...
				<div class="panel panel-flat">
					<div class="panel-body">
						<div class="form-group form-group12" style="border-radius: 0;">
							...
							<var><input id="consignee" name="consignee" class="form-control" type="text" maxlength="20"></var>
						</div>
						<div class="form-group form-group12" style="border-radius: 0;height: 9rem">
							...
							<var><div class="input-group" style="width: 100%">
						...
						<div class="form-group form-group12" style="border-radius: 0;">
							...
							<var><input id="address" name="address" class="form-control" type="text" maxlength="200"></var>
						</div>
						<div class="form-group form-group12" style="border-radius: 0;">
							<label style="text-align: center" for="zipCode">${message("Receiver.zipCode")}</label>
							<var><input id="zipCode" name="zipCode" class="form-control" type="text" maxlength="200"></var>
						</div>
						<div class="form-group form-group12" style="border-radius: 0;">
							<label style="text-align: center" for="phone">${message("Receiver.phone")}</label>
							<var><input id="phone" name="phone" class="form-control" type="text" maxlength="200" value="${currentUser.mobile}"></var>
						</div>
