				...
				<div class="panel-body">
					<div class="media">
						...
						<div class="media-right media-middle">
							<img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/><%-currency(productFavorite.product.price, false)%>
						</div>
					</div>
				</div>
