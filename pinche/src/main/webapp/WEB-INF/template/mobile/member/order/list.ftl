...
<body class="profile">
	...
	<div class="orderNav">
		<ul>
			...
			<li [#if status== "pendingPayment"]class="active"[/#if]><a href="${base}/member/order/list?status=pendingPayment">待付款</a></li>
			<li [#if status== "pendingShipment"]class="active"[/#if]><a href="${base}/member/order/list?status=pendingShipment" >待发货</a></li>
			<li [#if status== "shipped"]class="active"[/#if]><a href="${base}/member/order/list?status=shipped">待收货</a></li>
			<li [#if status== "completed"]class="active"[/#if]><a href="${base}/member/order/list?status=completed">已收货</a></li>
		</ul>
	</div>
