...
<div class="container" id="container" style="height: 100%;width: 100%">
    <div class="headerWarp">
        <div class="header" style="position: relative;width: 100%;height: 100%;display: flex;line-height:4.4rem;align-items: center;background:linear-gradient(126deg,rgba(150,100,111,1) 0%,rgba(107,107,138,1) 34%,rgba(217,124,117,1) 100%);">
    ...
    <form id="loginForm" action="${base}/member/login/saveWxLoginBindMobile" method="post">
    ...
    [#--<div class="logo"><h2 style="color:red;line-height:4rem;">为了保障您的账户安全，请绑定手机号</h2></div>--]
        ...
        <div id="boxone" style="display: block;margin: 0 auto;width:85.3%;height: 80%;"/>
            ...
            [/#if]
              ...
              [/#if]
            <div style="display: flex;justify-content:space-between;width: 100%;height: 3.8rem;margin-top:28px;border:0;border-radius:2.4rem;background:white;box-shadow:0px 0px 5px 0px rgba(206,206,206,1);">
                <div style="display: flex;align-items:center;width:4.0rem;height: 100%;">
                    <img src="${base}/newResources/member/images/phone.png" style="width: 3.0rem;height: 3.0rem;margin-left: 1rem;">
                </div>
            ...
            <div style="display: flex;justify-content:space-between;width: 100%;height: 3.8rem;margin-top:20px;border:0;border-radius:2.4rem;background:white;box-shadow:0px 0px 5px 0px rgba(206,206,206,1);">
                <div style="display: flex;align-items:center;justify-content:center;width:4.0rem;height: 100%;">
                    <img src="${base}/newResources/member/images/yzm.png" style="width:3rem;height: 3rem;margin-left: 1rem">
                </div>
                <div style="display:flex;align-items:center;width: 80%;height: 100%;">
                    ...
                    <input type="button" value="发送验证码" onclick="sendCode(this)" style="width: 45%;height: 3.0rem;font-size:1.4rem;color:white;font-family:ArialMT;border: none;outline: none;border-radius: 1.5rem;background:linear-gradient(270deg,rgba(147,114,133,1) 0%,rgba(148,114,132,1) 100%);
box-shadow:0px 6px 10px 0px rgba(206,206,206,1);">
                </div>
            </div>
            <div style="display: flex;justify-content:space-between;width: 70%;height: 3.8rem;margin:0 auto;margin-top:28px;border:0;border-radius:2.4rem;background:linear-gradient(297deg,rgba(147,114,133,1) 0%,rgba(148,114,132,1) 100%);
box-shadow:0px 6px 10px 0px rgba(206,206,206,1);">
