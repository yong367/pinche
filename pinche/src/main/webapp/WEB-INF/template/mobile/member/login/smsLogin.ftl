...
<div class="container" id="container" style="height: 100%;width: 100%">
    <form id="loginForm" action="${base}/member/login/smsLogin" method="post">
    ...
    <div class="zhuceBt">
        [#--<div class="tz">--]
            [#--<span>还没帐号？<a href="${base}/member/register" class="mfRegister">免费注册</a></span>--]
        [#--</div>--]
        <button type="submit">立即登录</button>
    </div>

    <div class="kjlogin">
        <a href="${base}/member/login">帐号登录</a>
    </div>
	</form>
</div>
[#--数据监控--]
