...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/common/index">${message("admin.breadcrumb.home")}</a> &raquo; 兑伴儿积分往来记录 <span>(${message("admin.page.total", page.total)})</span>
	</div>
	<form id="listForm" action="log" method="get">
		...
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="credit">收取积分</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="debit">支出积分</a>
				</th>
				<th>
			...
			[#list page.content as businessDepositLog]
				<tr>
					...
					<td>
                        <img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>${currency(businessDepositLog.credit, false)}
					</td>
					<td>
                        <img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>${currency(businessDepositLog.debit, false)}
					</td>
					<td>
                        <img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>${currency(businessDepositLog.balance, false)}
					</td>
					<td>
