...
<body>
	...
	<table class="input tabContent">
		...
		<tr>
			...
			<td>
                <img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>${currency(business.balance, false)}
		...
		[#if business.frozenFund > 0]
			<tr>
				...
				<td>
                    <img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>${currency(business.frozenFund, false)}
				</td>
			</tr>
		[/#if]
		<tr>
