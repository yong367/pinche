...
<body>
	...
	<form id="inputForm" action="update" method="post" enctype="multipart/form-data">
		...
		<table class="input tabContent">
            ...
            <tr>
                <th>
                    <span class="requiredField">*</span>默认会员头像:
                </th>
                <td>
					<span class="fieldSet">
						<input type="text" name="defaultMemberLogo" class="text" value="${setting.defaultMemberLogo}" maxlength="200" />
						<a href="javascript:;" class="button filePicker">${message("admin.upload.filePicker")}</a>
						<a href="${setting.defaultMemberLogo}" target="_blank">${message("admin.common.view")}</a>
					</span>
                </td>
            </tr>
			<tr>
		...
		<table class="input tabContent">
            ...
            <tr>
                <th>
                    <span class="requiredField">*</span>邀请注册积分奖励:
                </th>
                <td>
                    <input type="text" name="inviteRegisterPoint" class="text" value="${setting.inviteRegisterPoint}" maxlength="9" />
                </td>
            </tr>
			<tr>
				<th>
		...
		<table class="input tabContent">
            ...
            <tr>
                <th>
                    <span class="requiredField">*</span>订单二维码秘钥:
                </th>
                <td>
                    <input type="text" name="orderQrCodeSignKey" class="text" value="${setting.orderQrCodeSignKey}" />
                </td>
            </tr>
            <tr>
                <th>
                    <span class="requiredField">*</span>订单二维码有效时间:
                </th>
                <td>
                    <input type="text" name="orderQrCodeExpireTime" class="text" value="${setting.orderQrCodeExpireTime}" />单位分钟
                </td>
            </tr>
            <tr>
                <th>
                    <span class="requiredField">*</span>用户邀请获赠比率:
                </th>
                <td>
                    <input type="text" name="distributionDonationRatio" class="text" value="${setting.distributionDonationRatio}" />
                </td>
            </tr>
            <tr>
                <th>
                    <span class="requiredField">*</span>短信群发资费:
                </th>
                <td>
                    <input type="text" name="smsPushAmount" class="text" value="${setting.smsPushAmount}" />
                </td>
            </tr>
			<tr>
				<th>
            ...
            <tr>
                <th>
                    <span class="requiredField">*</span>短信通道:
                </th>
                <td>
                    <input type="text" name="smsChannel" class="text" value="${setting.smsChannel}" />
                </td>
            </tr>
		</table>
		<table class="input">
