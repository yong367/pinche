...
<body>
	...
	<table class="input tabContent">
		...
		<tr>
			...
			<td>
                <img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>${currency(order.price, false)}
			</td>
			<th>
		...
		<tr>
			...
			<td>
				...
				[#if order.amountPayable > 0]
					<span class="silver">(${message("Order.amountPayable")}: <img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>${currency(order.amountPayable, false)})</span>
				[/#if]
			</td>
		</tr>
		[#if order.refundAmount > 0 || order.refundableAmount > 0]
			<tr>
				...
				<td>
                    <img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>${currency(order.refundAmount, false)}
				</td>
				<th>
					${message("Order.refundableAmount")}:
				</th>
				<td>
                    <img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>${currency(order.refundableAmount, false)}
				</td>
			</tr>
		[/#if]
		<tr>
		...
		<tr>
			...
			<td>
                <img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>${currency(order.promotionDiscount, false)}
			</td>
		</tr>
		<tr>
			<th>
			...
			<td>
                <img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>${currency(order.couponDiscount, false)}
			</td>
		</tr>
		<tr>
			<th>
			...
			<td>
                <img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>${currency(order.fee, false)}
			</td>
			<th>
				${message("Order.freight")}:
			</th>
			<td>
                <img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>${currency(order.freight, false)}
			</td>
		</tr>
		<tr>
			<th>
			...
			<td>
                <img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>${currency(order.offsetAmount, false)}
			</td>
			<th>
		...
		[#if order.invoice??]
			<tr>
				...
				<td>
                    <img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>${currency(order.tax, false)}
				</td>
			</tr>
		[/#if]
		<tr>
	...
	<table class="item tabContent">
		...
		[#list order.orderPayments as orderPayment]
			<tr>
				...
				<td>
                    <img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>	${currency(orderPayment.fee, false)}
				</td>
				<td>
                    <img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>${currency(orderPayment.amount, false)}
				</td>
				<td>
	...
	<table class="item tabContent">
		...
		[#list order.orderRefunds as orderRefunds]
			<tr>
				...
				<td>
                    <img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>${currency(orderRefunds.amount, false)}
				</td>
				<td>
