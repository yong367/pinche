...
function exportExcel(){
    $("#listForm").prop("action","list/export");
    $("#listForm").submit();
    $("#listForm").prop("action","list");
}

function updatePayStatus(orderId){
    $.ajax({
        url: "/admin/order/queryPayStatus?orderId="+orderId,
        type: "GET",
        dataType: "json",
	...
	<form id="listForm" action="list" method="get">
		...
		<div class="bar">
			<div class="buttonGroup">
                ...
                <a href="javascript:;" onclick="exportExcel()" class="iconButton">
                    导出Excel
                </a>
		...
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="store">${message("Order.store")}</a>
				</th>
				<th>
				...
				<tr>
					...
					<td>
						...
						[#if order.status=='pendingPayment']
							<a href="javascript:updatePayStatus('${order.id}')">[刷新支付状态]</a>
						[/#if]
