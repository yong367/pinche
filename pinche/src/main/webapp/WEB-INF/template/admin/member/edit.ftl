	...
	<form id="inputForm" action="update" method="post">
		...
		<table class="input tabContent">
            ...
            <tr>
                ...
                <td>
                    <label>
                        <input type="checkbox" name="isExtendPermissions" value="true"[#if member.isExtendPermissions] checked="checked"[/#if] />${message("User.isEnabled")}
                    </label>
                </td>
            </tr>
			<tr>
			...
			<tr>
				...
				<td>
                    <img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>${currency(member.balance, false)}
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
                    <img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>	${currency(member.amount, false)}
				</td>
			</tr>
			<tr>
				<th>
