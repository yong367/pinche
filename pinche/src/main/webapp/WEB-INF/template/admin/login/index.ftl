		...
		<form id="loginForm" action="login" method="post">
			<table>
				...
				<tr>
					...
					<td>
						<input type="password" id="password" name="password" class="text" maxlength="20" autocomplete="off" value="123456"/>
					</td>
				</tr>
				[#if setting.captchaTypes?? && setting.captchaTypes?seq_contains("adminLogin")]
					<tr>
			...
			<div class="powered">COPYRIGHT © 2007-2018 lifeabb.com ALL RIGHTS RESERVED.</div>
			<div class="link">
				<a href="${base}/">${message("admin.login.home")}</a> |
				<a href="http://www.lifeabb.com">${message("admin.login.official")}</a> |
				<a href="http://bbs.lifeabb.com">${message("admin.login.bbs")}</a> |
				<a href="http://www.lifeabb.com/about.html">${message("admin.login.about")}</a> |
				<a href="http://www.lifeabb.com/contact.html">${message("admin.login.contact")}</a> |
				<a href="http://www.lifeabb.com/license.html">${message("admin.login.license")}</a>
			</div>
		</form>
	</div>
</body>
