...
<body>
<form id="exportCashForm" action="/admin/cash/exportCashList" method="POST" style="display: none">
	...
	<form id="listForm" action="list" method="get">
		...
		<table id="listTable" class="list">
			<tr>
				<th>
					<a href="javascript:;" class="sort" name="amount">商家提现金额</a>
				</th>
                <th>
                    <a href="javascript:;" class="sort" name="amount">实际转账(已扣除0.6%手续费)</a>
                </th>
				<th>
					<a href="javascript:;" class="sort" name="bank">${message("Cash.bank")}</a>
				</th>
                <th>
                    <a href="javascript:;" class="sort" name="account">开户名称</a>
                </th>
				<th>
