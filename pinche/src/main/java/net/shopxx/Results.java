...
public final class Results {
	...
	public static ResponseEntity<Map<String, String>> status(HttpStatus httpStatus, String message) {
		Assert.notNull(httpStatus);
		Assert.hasText(message);
		Map<String, String> data = new HashMap<>();
	 ...
	 * @return 200状态ResponseEntity
	 */
	public static ResponseEntity<Map<String, String>> ok(Map<String, String> result) {
	...
	/**
	 * 返回422状态ResponseEntity
	 *自定义的返回，不走spring的国际化框架，直接返回字符串结果到页面上
	 * @param message
	 *            消息
	 *            参数
	 * @return 422状态ResponseEntity
	 */
	public static ResponseEntity<Map<String, String>> customEntity(String message) {
		return status(HttpStatus.UNPROCESSABLE_ENTITY, message);
	}
