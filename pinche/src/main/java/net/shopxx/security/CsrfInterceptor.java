...
public class CsrfInterceptor extends HandlerInterceptorAdapter {
	 ...
	 * 默认无需防护的请求方法
	 */
	private static final String[] DEFAULT_NOT_REQUIRE_PROTECTION_REQUEST_METHODS = new String[] { "GET", "HEAD", "TRACE", "OPTIONS","POST" };//
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
		...
		if (!containsIgnoreCase(getNotRequireProtectionRequestMethods(), request.getMethod())) {
			...
			if (!StringUtils.equals(csrfToken, actualCsrfToken)) {
				//System.out.println("csrfToken:"+csrfToken+"|actualCsrfToken:"+actualCsrfToken);
