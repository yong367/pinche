...
public class StoreController extends BaseController {
	...
	public String update(Store store, Long id, Long storeRankId, Long storeCategoryId, Long[] productCategoryIds, RedirectAttributes redirectAttributes) {
		...
		pStore.setDetailAddress(store.getDetailAddress());
		...
		pStore.setBusinessHours(store.getBusinessHours());
...
//	}
	 ...
	 */
	@GetMapping("/review")
	public String review(Long id,String status, RedirectAttributes redirectAttributes) {
		Store store = storeService.find(id);
		if (store == null || !Store.Status.pending.equals(store.getStatus()) || status == null ) {
			return ERROR_VIEW;
		}
