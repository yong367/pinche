...
public abstract class PaymentPlugin implements Comparable<PaymentPlugin> {
	 ...
	 * @throws Exception
	 */
	public abstract QueryPayStatusResponse queryPaySuccess(PaymentTransaction paymentTransaction) throws Exception;

	/**
	 * 订单退款
	 */
	public abstract QueryOrderRefundStatusResponse queryOrderRefundSuccess(PaymentTransaction paymentTransaction) throws Exception;
	/**
	 * 获取支付前处理URL
	 * 
	 * @param paymentPlugin
