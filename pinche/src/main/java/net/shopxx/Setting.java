...
public class Setting implements Serializable {
	...
	private BigDecimal smsPushAmount;
	/**
	 * 区域设置
	 */
	public enum Locale {
	 ...
	 */
	@NotEmpty
	private String distributionDonationRatio;
	 ...
	 */
	@NotEmpty
	private String orderQrCodeExpireTime;
	...
	@Length(max = 200)
	@Pattern(regexp = "^(?i)(http:\\/\\/|https:\\/\\/|\\/).*$")
	private String defaultMemberLogo;
	...
	@NotNull
	@Min(0)
	private Long inviteRegisterPoint;
	 ...
	 */
	@Length(max = 200)
	private String orderQrCodeSignKey;
	...
	public Long getInviteRegisterPoint() {
		return inviteRegisterPoint;
	}

	public void setInviteRegisterPoint(Long inviteRegisterPoint) {
		this.inviteRegisterPoint = inviteRegisterPoint;
	}
	 ...
	 * @return
	 */
	public String getDistributionDonationRatio() {
		return distributionDonationRatio;
	}

	public void setDistributionDonationRatio(String distributionDonationRatio) {
		this.distributionDonationRatio = distributionDonationRatio;
	}
	...
	public String getOrderQrCodeSignKey() {
		return orderQrCodeSignKey;
	}

	public void setOrderQrCodeSignKey(String orderQrCodeSignKey) {
		this.orderQrCodeSignKey = orderQrCodeSignKey;
	}
	...
	public String getDefaultMemberLogo() {
		return defaultMemberLogo;
	}

	public void setDefaultMemberLogo(String defaultMemberLogo) {
		this.defaultMemberLogo = defaultMemberLogo;
	}
	...
	public String getOrderQrCodeExpireTime() {
		return orderQrCodeExpireTime;
	}

	public void setOrderQrCodeExpireTime(String orderQrCodeExpireTime) {
		this.orderQrCodeExpireTime = orderQrCodeExpireTime;
	}
	...
	public BigDecimal getSmsPushAmount() {
		return smsPushAmount;
	}

	public void setSmsPushAmount(BigDecimal smsPushAmount) {
		this.smsPushAmount = smsPushAmount;
	}
}
