...
public class Product extends BaseEntity<Long> {
	 ...
	 * 是否显示等级分配
	 */
	private boolean gradeDistributionFlag;

	public boolean getGradeDistributionFlag() {
		return gradeDistributionFlag;
	}

	public void setGradeDistributionFlag(boolean gradeDistributionFlag) {
		this.gradeDistributionFlag = gradeDistributionFlag;
	}
	...
	@JsonView(BaseView.class)
	@Transient
	public String getPricePartOne() {
		Sku sku=getDefaultSku();
		BigDecimal amount=sku.getPrice();
	...
	public String getProductTag() {
		if(productTags.size()>0){
			Iterator<ProductTag> it= productTags.iterator();
	...
	@JsonView(BaseView.class)
	@Transient
	public BigDecimal getRewardDuiBan() {
		Sku defaultSku = getDefaultSku();
		return defaultSku != null ? defaultSku.getRewardDuiBan() : null;
	}
	...
	@JsonView(BaseView.class)
	@Transient
	public BigDecimal getRewardYongJin() {
		Sku defaultSku = getDefaultSku();
		return defaultSku != null ? defaultSku.getRewardYongJin() : null;
	}
	...
	public void setIsLimitBuy(Boolean limitBuy) {
		isLimitBuy = limitBuy;
	}
