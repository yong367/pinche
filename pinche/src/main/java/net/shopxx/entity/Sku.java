...
public class Sku extends BaseEntity<Long> {
	 ...
	 * 普通商品验证组
	 */
	public interface Coupon extends Default {
	...
	@Min(0)
	@Column(precision = 21, scale = 6)
	private BigDecimal rewardDuiBan;
	/**
	 * 赠送佣金兑伴
	 */
	@Min(0)
	@Column(precision = 21, scale = 6)
	private BigDecimal rewardYongJin;
	...
	public void setRewardDuiBan(BigDecimal rewardDuiBan) {
		this.rewardDuiBan = rewardDuiBan;
	}
	 ...
	 * @return
	 */
	public BigDecimal getRewardYongJin() { return rewardYongJin; }

	/**
	 * 设置赠送佣金
	 * @param rewardYongJin
	 */
	public void setRewardYongJin(BigDecimal rewardYongJin) { this.rewardYongJin = rewardYongJin; }
