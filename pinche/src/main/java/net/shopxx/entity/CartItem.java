...
public class CartItem extends BaseEntity<Long> {
	...
	public BigDecimal getRewardDuiBan() {
		if (getSku() != null && getSku().getRewardDuiBan() != null && getQuantity() != null) {
			return getSku().getRewardDuiBan().multiply(new BigDecimal(getQuantity()));
		} else {
	...
	public BigDecimal getRewardYongJin() {
		if (getSku() != null && getSku().getRewardYongJin() != null && getQuantity() != null) {
			return getSku().getRewardYongJin().multiply(new BigDecimal(getQuantity()));
		} else {
			return BigDecimal.ZERO;
		}
	}
