...
public class Member extends User {
	 ...
	 */
	@Column(nullable = false)
	private Boolean isExtendPermissions = true;

	@Column(nullable = false)
	private boolean distributionPermissions=false;
	 ...
	 * 首次奖励标识
	 */
	private boolean firstAwardFlag=false;
	...
	private int signInLastTime;

	public boolean getFirstAwardFlag() {
		return firstAwardFlag;
	}

	public void setFirstAwardFlag(boolean firstAwardFlag) {
		this.firstAwardFlag = firstAwardFlag;
	}

	public void setSignInLastTime(int signInLastTime) {
		this.signInLastTime = signInLastTime;
	}

	public int getSignInLastTime() {
	...
	public boolean getDistributionPermissions() {
		return distributionPermissions;
	}

	public void setDistributionPermissions(boolean distributionPermissions) {
	...
	public String getShareCodeImgUrl() {
		return shareCodeImgUrl;
	}

	public void setShareCodeImgUrl(String shareCodeImgUrl) {
		this.shareCodeImgUrl = shareCodeImgUrl;
	}
	...
	public Boolean getIsExtendPermissions() {
		return isExtendPermissions;
	}

	public void setIsExtendPermissions(Boolean extendPermissions) {
		isExtendPermissions = extendPermissions;
	}
}