...
public class Business extends User {
	 ...
	 * 选择身份信息
	 */
	public enum ChooseIdEntityInformation {
		/**
		 * 商户
		 */
		merchant,
	 ...
	 * 选择企业或个人
	 */
	public enum ChooseCompanyOrPerson {
        /**
         * 企业
         */
        company,
	...
	static {
		...
		NORMAL_BUSINESS_PERMISSIONS.add("business:task");
		NORMAL_BUSINESS_PERMISSIONS.add("business:productCoupon");
	}
	 ...
	 * 选择身份
	 */
    private ChooseIdEntityInformation chooseIdEntityInformation;
	/**
	 * 选择企业或个人
	 */
	private ChooseCompanyOrPerson chooseCompanyOrPerson;
	/**
	 * 电话
	 */
	@Length(max = 200)
	 ...
	 */
	@Length(max = 200)
	private String reverseIdCardImage;
	/**
	 * 组织机构代码
	 */
	@Length(max = 200)
	...
	@Column(nullable = false)
	private boolean gradeGiftBag=false;

	public void setGradeGiftBag(boolean gradeGiftBag) {
		this.gradeGiftBag = gradeGiftBag;
	}

	public boolean getGradeGiftBag() {
		return gradeGiftBag;
	}
	...
	public ChooseIdEntityInformation getChooseIdEntityInformation() {
		return chooseIdEntityInformation;
	}

	public String getReverseIdCardImage() { return reverseIdCardImage; }

	public void setReverseIdCardImage(String reverseIdCardImage) { this.reverseIdCardImage = reverseIdCardImage; }

	public void setChooseIdEntityInformation(ChooseIdEntityInformation chooseIdEntityInformation) {
		this.chooseIdEntityInformation = chooseIdEntityInformation;
	}

	public ChooseCompanyOrPerson getChooseCompanyOrPerson() {
		return chooseCompanyOrPerson;
	}

	public void setChooseCompanyOrPerson(ChooseCompanyOrPerson chooseCompanyOrPerson) {
		this.chooseCompanyOrPerson = chooseCompanyOrPerson;
	}
	...
	public boolean isValidCredentials(Object credentials) {
		return credentials != null && (credentials instanceof char[] ? new String((char[]) credentials) : credentials.toString()).equals(getEncodedPassword());
	}
