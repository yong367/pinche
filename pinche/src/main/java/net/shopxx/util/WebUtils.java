...
public final class WebUtils {
	...
	public static String postXmlToWx(String url,String xml,Boolean useCert,WxPayServerConfig wxPayServerConfig) throws Exception {
		BasicHttpClientConnectionManager connManager;
		/**5.操作证书**/
		if (useCert) {
			// 证书
			char[] password = wxPayServerConfig.getMerchantId().toCharArray();
			InputStream certStream = new FileInputStream(new File(wxPayServerConfig.getSslcertPath()));
		...
		httpPost.addHeader("User-Agent", "wxpay sdk java v1.0 " + wxPayServerConfig.getMerchantId());  // TODO: 很重要，用来检测 sdk 的使用情况，要不要加上商户信息？
