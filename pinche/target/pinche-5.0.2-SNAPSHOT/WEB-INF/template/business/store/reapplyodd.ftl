...
<head>
	...
	$().ready(function() {
		...
		$storeRankServiceFee.html('<img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>'+currency($storeRankServiceFeeSelected, false));
		...
		// 店铺分类
		$storeCategoryBail.text('<img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>'+currency($storeCategoryBailSelected, false));
