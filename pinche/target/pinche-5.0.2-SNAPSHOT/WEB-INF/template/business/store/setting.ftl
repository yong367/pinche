								...
								<div class="box">
									<div class="box-body">
										...
										<div class="form-group">
											...
											<div class="col-xs-4">
												<input id="address" name="detailAddress" class="form-control" type="text" value="${currentStore.detailAddress}" maxlength="200">
											</div>
										</div>
                                        <div class="form-group">
                                            <label class="col-xs-2 control-label" for="address">营业时间:</label>
                                            <div class="col-xs-4">
                                                <input id="businessHours" name="businessHours" class="form-control" type="text" value="${currentStore.businessHours}" maxlength="200">
                                            </div>
                                        </div>
										<div class="form-group">
