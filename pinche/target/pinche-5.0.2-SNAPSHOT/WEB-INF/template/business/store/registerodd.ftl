...
<head>
	...
	$().ready(function() {
		...
		$storeRankServiceFee.velocity("fadeIn").html('<img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>'+currency($storeRankServiceFeeDefault, false));
		$storeRank.change(function() {
			...
			$storeRankServiceFee.velocity("fadeIn").html('<img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>'+currency(storeRankServiceFee, false));
		});
		
		// 店铺分类
		$storeCategoryBail.velocity("fadeIn").html('<img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>'+currency($storeCategoryBailDefault, false));
		$storeCategory.change(function() {
			var $element = $(this);
			var storeCategoryBail = $element.find(":selected").data("store-category-bail");
			$storeCategoryBail.velocity("fadeIn").html('<img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>'+currency(storeCategoryBail, false));
		});
