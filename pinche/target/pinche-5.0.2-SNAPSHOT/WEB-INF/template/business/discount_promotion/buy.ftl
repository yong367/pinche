									...
									<div class="box-body">
										[#if currentStore.endDate??]
											...
											<div class="form-group">
												...
												<div class="col-xs-4">
													<p class="form-control-static"><img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>${message("business.discountPromotion.price", currency(promotionPlugin.price, false))}</p>
												</div>
											</div>
											<div class="form-group">
