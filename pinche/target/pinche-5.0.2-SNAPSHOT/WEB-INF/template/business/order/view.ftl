							...
							<div class="box">
								<div class="box-body">
															...
															<div class="row">
																<div class="col-xs-6">
																	<dl class="items dl-horizontal">
																		...
																		<dd><img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>${currency(order.amount, false)}</dd>
																	</dl>
																</div>
																<div class="col-xs-6">
																	<dl class="items dl-horizontal">
																		...
																		<dd><img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>${currency(order.amountPayable, false)}</dd>
																	</dl>
																</div>
																<div class="col-xs-6">
															...
															<div class="row">
																...
																<div class="col-xs-6">
																	<dl class="items dl-horizontal">
																		...
																		<dd><img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>${currency(order.refundableAmount, false)}</dd>
																	</dl>
																</div>
																...
																<div class="col-xs-6">
																	<div class="form-group">
																		...
																		<div class="col-xs-8">
																			<input id="amount" name="amount" class="form-control" readonly type="text" value="${order.refundableAmount}" maxlength="16">
																		</div>
																	</div>
																</div>
									...
									[/#if]
										...
										<form class="form-horizontal" action="${base}/business/order/directComplete" method="post">
                                            <input name="orderId" type="hidden" value="${order.id}">
                                            <div id="directCompleteModal" class="modal fade" tabindex="-1">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <button class="close" type="button" data-dismiss="modal">&times;</button>
												...
												<div class="row">
													...
													<div class="col-xs-6">
														<dl class="items dl-horizontal">
															...
															<dd><img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>${currency(order.price, false)}</dd>
															<dt>${message("Order.amount")}:</dt>
															<dd><img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>${currency(order.amount, false)}</dd>
															[#if order.refundAmount > 0 || order.refundableAmount > 0]
																<dt>${message("Order.refundAmount")}:</dt>
																<dd><img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>${currency(order.refundAmount, false)}</dd>
																<dt>${message("Order.refundableAmount")}:</dt>
																<dd><img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>${currency(order.refundableAmount, false)}</dd>
															[/#if]
															...
															<dd><img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>${currency(order.fee, false)}</dd>
															<dt>${message("Order.offsetAmount")}:</dt>
															<dd><img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>${currency(order.offsetAmount, false)}</dd>
													...
													<div class="col-xs-6">
														<dl class="items dl-horizontal">
															...
															<dd>
                                                                <img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>${currency(order.amountPaid, false)}
																[#if order.amountPayable > 0]
																	<span class="orange">(${message("Order.amountPayable")}: <img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>${currency(order.amountPayable, false)})</span>
																[/#if]
															</dd>
															[#if order.invoice??]
																...
																<dd><img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>${currency(order.tax, false)}</dd>
															[/#if]
															...
															<dd><img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>${currency(order.promotionDiscount, false)}</dd>
															<dt>${message("Order.couponDiscount")}:</dt>
															<dd><img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>${currency(order.couponDiscount, false)}</dd>
															<dt>${message("Order.freight")}:</dt>
															<dd><img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>${currency(order.freight, false)}</dd>
													...
													<tbody>
														[#list order.orderPayments as orderPayment]
															<tr>
																...
																<td><img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>${currency(orderPayment.fee, false)}</td>
																<td><img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>${currency(orderPayment.amount, false)}</td>
																<td>
													...
													<tbody>
														[#list order.orderRefunds as orderRefunds]
															<tr>
																...
																<td><img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>${currency(orderRefunds.amount, false)}</td>
																<td>
