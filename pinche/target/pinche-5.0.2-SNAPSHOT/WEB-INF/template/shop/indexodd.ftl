			...
			<div class="span2">
				[@product_category_root_list count = 6]
					<div id="productCategoryMenu" class="productCategoryMenu">
						<ul>
							st productCategories as productCategory]
								<li>
										...
										[#if product_index < 5]
											<li>
												<a href="${base}${product.path}" title="${product.name}" target="_blank">
													...
													<strong><img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>${currency(product.price, false)}</strong>
