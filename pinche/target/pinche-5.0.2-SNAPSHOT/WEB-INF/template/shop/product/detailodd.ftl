								...
								[#if setting.isShowMarketPrice]
									<dd>
										<span>
											...
											<del id="marketPrice"><img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>${currency(defaultSku.marketPrice, false)}</del>)
										</span>
									</dd>
								[/#if]
							</dl>
						...
						[#else]
							...
							[#if setting.isShowMarketPrice]
								<dl>
									...
									<dd id="marketPrice">
                                        <img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>${currency(defaultSku.marketPrice, false)}
									</dd>
								</dl>
							[/#if]
						[/#if]
