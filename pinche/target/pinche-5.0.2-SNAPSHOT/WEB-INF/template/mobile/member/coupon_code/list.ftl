...
<body class="profile">
	...
	<div style="width: 90%; height: 125px;margin:0 auto;margin-top: 20px;">
        <img src="${base}/resources/mobile/member/images/youhuiquan.png" style="float: left;width: 75%;height: 110px;">
		<span style="    width: 25%; float: left;">
			<img src="${base}/resources/mobile/member/images/youhui_sc.png" style="width: 54px;margin: 10px 20px;">
			<div style="text-align: center;margin-left: 10%">剩余时间<br/>15天23:12</div>
		</span>
	</div>
    <div style="width: 90%; height: 125px;margin:0 auto;margin-top: 20px;">
        <img src="${base}/resources/mobile/member/images/youhuiquan.png" style="float: left;width: 75%;height: 110px;">
...
<div style="clear" style="clear: both"></div>
</body>
</html>