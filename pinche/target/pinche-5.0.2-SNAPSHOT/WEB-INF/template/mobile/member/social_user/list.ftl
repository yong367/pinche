...
<body class="profile">
	<header class="header-fixed" style="    background: linear-gradient(126deg,rgba(150,100,111,1) 0%,rgba(107,107,138,1) 34%,rgba(217,124,117,1) 100%);color: #FFFFFF">
		...
		<span style="margin-left: 40px;font-size: 16px">${message("member.socialUser.list")}</span>
		<span style="float: right;padding-right: 10px;font-size:14px;display:[#if page.content?has_content] none;[#else]block;[/#if]" onclick="window.location.href='/member/bind/preBindWx'">绑定微信</span>
	</header>
	<main>
