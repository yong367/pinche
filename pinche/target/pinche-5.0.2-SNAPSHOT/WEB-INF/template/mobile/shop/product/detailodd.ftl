		...
		<div id="specification" class="specification">
			<div class="specification-header">
				...
				[#if product.type == "general"]
					<strong class="price red"><img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>${currency(defaultSku.price, false)}</strong>
					[#if setting.isShowMarketPrice]
						<del class="market-price gray-darker"><img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>${currency(defaultSku.marketPrice, false)}</del>
					[/#if]
