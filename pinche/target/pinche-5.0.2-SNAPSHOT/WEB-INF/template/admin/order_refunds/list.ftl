...
<title>${message("admin.orderRefunds.list")} </title>
		...
		<table id="listTable" class="list">
			...
			[#list page.content as refunds]
				<tr>
					...
					<td>
                        <img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>${currency(refunds.amount, false)}
					</td>
					<td>
						${refunds.payee}
					</td>
