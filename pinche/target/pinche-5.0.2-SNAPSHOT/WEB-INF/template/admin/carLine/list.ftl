...
<body>
	...
	<form id="listForm" action="/admin/memberCar/list" method="get">
		<div class="bar">
            <a href="/admin/carLine/add" class="iconButton">
		...
		<table id="listTable" class="list">
			...
			[#list page.content as carline]
				<tr>
					...
					<td>
						[#if carline.useStatus]启用[#else ]禁用[/#if]
					</td>
					<td>
						<span title="${carline.createdDate?string("yyyy-MM-dd HH:mm:ss")}">${carline.createdDate?string("yyyy-MM-dd")}</span>
					</td>
                    <td>
