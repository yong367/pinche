		...
		<table id="listTable" class="list">
			...
			[#list page.content as memberDepositLog]
				<tr>
					...
					<td>
                        <img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>	${currency(memberDepositLog.credit, false)}
					</td>
					<td>
                        <img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>${currency(memberDepositLog.debit, false)}
					</td>
					<td>
                        <img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>${currency(memberDepositLog.balance, false)}
					</td>
					<td>
