				...
				<div class="input order">
					...
					<table class="info">
						...
						<tr>
							...
							<td>
                                <img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>	${currency(order.amount, false)}
							</td>
						</tr>
						...
						[#if order.amountPayable > 0]
							<tr>
								...
								<td>
                                    <img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>${currency(order.amountPayable, false)}
								</td>
							</tr>
						[/#if]
