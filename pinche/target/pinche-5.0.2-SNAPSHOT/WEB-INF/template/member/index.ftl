								...
								<table>
									[#list newOrders as order]
										<tr [#if !order_has_next] class="last"[/#if]>
											...
											<td class="orderPrice">
												<span class="pagePrice"><img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>${currency(order.amount, false)}</span>${order.paymentMethodName}
											</td>
											<td class="orderDate">
								...
								<table>
									[#list currentUser.cart.cartItems as cartItem]
										<tr [#if !cartItem_has_next] class="last"[/#if]>
											...
											<td class="tdCenter"><span class="pagePrice"><img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>${cartItem.price}</span></td>
										</tr>
										[#if cartItem_index == 2]
											[#break /]
										[/#if]
										...
										[#list productFavorites as productFavorite]
											<tr [#if !productFavorite_has_next] class="last"[/#if]>
												<td width="150" class="shopSt">
													...
													<span class="pagePrice"><img style="width: 15px;height: 15px;" src="${setting.currencySign}"  alt="${setting.currencyIconName}"/>${currency(productFavorite.product.price, false)}</span>
												</td>
											</tr>
